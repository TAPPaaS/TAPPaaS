...
| Zone | srvWork (10.2.20.0/24, VLAN 220) |
| Internal host | `openwebui.srvWork.internal` |
| Port | 8080 |
...
### 1. VM not reachable
```bash
ssh tappaas@openwebui.srvWork.internal
```
...
1. Verify LiteLLM is running: `nc -zv -w 5 litellm.srvWork.internal 4000`
