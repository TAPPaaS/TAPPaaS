...
if ssh -o BatchMode=yes -o StrictHostKeyChecking=accept-new -o LogLevel=ERROR "root@${NODE_FQDN}" \
    ...
    VOLID="$(ssh -o BatchMode=yes -o StrictHostKeyChecking=accept-new -o LogLevel=ERROR "root@${NODE_FQDN}" \
...
for _i in $(seq 1 30); do
    _st="$(ssh -o BatchMode=yes -o StrictHostKeyChecking=accept-new -o LogLevel=ERROR "root@${NODE_FQDN}" \
