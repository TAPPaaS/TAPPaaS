...
# happens in the consumer's firewall:rules invocation. This script just logs
# and exits 0.
#
...
info "test-fw-c:web install-service for consumer '${CONSUMER}' — no provider-side work needed (auto-pinhole handled by consumer's firewall:rules)."
