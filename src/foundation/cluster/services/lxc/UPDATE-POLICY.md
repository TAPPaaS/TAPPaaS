...
| `vmtag` | in-place | set | tags | seed | As cluster:vm. |
...
| `diskSize` | manual | none | — | seed | Not grown by this service today. *See [recommendation 3](../../../tappaas-cicd/UPDATE-POLICY.md#3-reconsider-clusterlxc-disksize-as-grow-only).* |
| `storage` | manual | none | — | seed | For a bind-mounted CT this is not a move at all. |
