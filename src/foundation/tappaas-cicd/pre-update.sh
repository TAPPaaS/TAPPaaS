...
for _oc_tool in opnsense-controller zone-manager dns-manager caddy-manager opnsense-firewall rules-manager syslog-manager test-network-manager acme-manager authentik-manager; do
