...
let err = undefined;
try {
    (0, cli_1.requireOperator)(0);
}
catch (e) {
    err = e;
}
check(err instanceof cli_1.DieError, "requireOperator(0) throws DieError (refuses root)");
// ── 3. -1 (uid unavailable) → treated as non-root, no throw ──────────────
threw = false;
try {
    (0, cli_1.requireOperator)(-1);
}
catch {
    threw = true;
}
