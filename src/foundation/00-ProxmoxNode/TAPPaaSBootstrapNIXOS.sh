...
msg_ok "We have 4 steps to complete: 1. install VM tools 2. download NixOS 3. Create a TAPPaaS template. 4. Create TAPPaaS CICD VM."
...
msg_info "Step 2. Downloading NixOS Image-ISO"
curl -f#SL -o "$(basename "$NIXURL")" "$NIXURL"
echo -en "\e[1A\e[0K"
...
msg_info "Bonus Step: set up a few configurations on PVE node to support terraform and ansible"
