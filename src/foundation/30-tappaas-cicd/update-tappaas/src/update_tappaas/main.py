#!/usr/bin/env python3
"""TAPPaaS update utility - main entry point."""
...
def main():
    ...
    parser = argparse.ArgumentParser(description="TAPPaaS update utility")
    parser.add_argument(
        "--tappaas-node",
        default="tappaas1",
        help="Name of the TAPPaaS node to update (default: tappaas1)"
    )
    args = parser.parse_args()

    node = args.tappaas_node
