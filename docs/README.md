...
- [`Architecture/`](Architecture/) — continuously maintained architecture concept docs. (The glossary/ontology SSOT is now [`GLOSSARY.md`](../GLOSSARY.md) at the repo root.)
