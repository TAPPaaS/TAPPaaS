...
| | |
|---|---|
| **Status** | **Proposed** — design pass for #498, all open questions resolved; P0–P6 implemented; v0.6 adds D9 (install records what it used; the schema default is desired state for every field), **decided and now built**; v0.7 adds D10, whose declaration half **is** built and whose enforcement half is #567. |
| **Version** | 0.7 |
| **Date** | 2026-09-03 |
| **Author** | Lars Rossen |
...
### D10. The module-level fields are declared too — enforcement deferred to #567
