...
| `oci` (022d's atomic container value — nesting mechanism still open, value decided) | [OCI Image & Runtime Specifications](https://opencontainers.org/) |
