...
Most people have an idea on what a Home is. However the definition is very dependent on the context. As this project targets all IT in a home then it would be appropriate to define what we man by Home.
